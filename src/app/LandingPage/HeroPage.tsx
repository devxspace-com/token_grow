    ...
    <main className="relative">
      <section className="flex mt-[100px] relative ">
        ...
        <div className="ml-[184px] smDesktop:ml-[90px] tabletAir:ml-[60px] smDesktop:z-[1] relative mobile:ml-0">
          <h1 className="w-[745px] text-[56px] surfaceDuo:text-[24px] mobile:text-[24px] tabletAir:w-[100%] tabletAir:leading-[60px] smDesktop:text-[48px] leading-[73px] tracking-[0.03em] text-[#FFFFFF] headingTag font-[800] mobile:leading-8 mobile:w-[90%] mobile:mx-auto">
            The Future Of Agricultural Investment Is Here
          </h1>
          <p className="w-[403px] mt-[28px] tabletAir:mt-[16px] text-[16px] font-[400] leading-5 tracking-[0.03em] text-[#FFFFFF] mobile:w-[90%] mobile:mx-auto ">
          ...
          <div className="mt-[28px] flex gap-[30px] mobile:w-[90%] mobile:mx-auto">
        ...
        <div className="absolute w-[760px] h-[520px] smDesktop:w-[660px] smDesktop:h-[420px] top-[-48px] tabletAir:w-[100%] tabletAir:left-0 tabletAir:right-0 surfaceDuo:w-[100%] surfaceDuo:right-0 surfaceDuo:left-[44px] right-[70px] mobile:mt-[-60px]">
