  ...
  return (
    <main className="relative">
      <section className="flex mt-[100px] relative ">
        <div className="ml-[184px] smDesktop:ml-[90px] smDesktop:z-[1] tabletAir:ml-[0px] tablet:ml-[0px] relative">
          <h1 className="w-[745px] text-[56px] surfaceDuo:text-[24px] mobile:text-[24px] surfaceDuo:w-[90%] surfaceDuo:mx-auto  smDesktop:text-[48px] leading-[73px] tracking-[0.03em] text-[#FFFFFF] headingTag font-[800]">
            The Future Of Agricultural Investment Is Here
          </h1>
          <p className="w-[403px] mt-[28px] text-[16px] font-[400] leading-5 tracking-[0.03em] text-[#FFFFFF] ">
          ...
          <div className="mt-[28px] flex gap-[30px]">
        ...
        <div className="absolute w-[760px] h-[520px] smDesktop:w-[660px] smDesktop:h-[420px] top-[-48px] surfaceDuo:w-[100%] surfaceDuo:right-0 surfaceDuo:left-[44px] right-[70px]">
